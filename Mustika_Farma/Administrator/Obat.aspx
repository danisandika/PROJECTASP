              ...
              <div class="card-header">
                ...
                <asp:GridView ID="gridObat" runat="server" CssClass="table table-hover"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="IDJenis" HeaderText="ID Jenis Obat"  NullDisplayText="-" ItemStyle-HorizontalAlign="Left" SortExpression="IDJenis" />
                        ...
                        <asp:BoundField DataField="IDLokasi" HeaderText="Lokasi"  NullDisplayText="-" ItemStyle-HorizontalAlign="Left" SortExpression="IDLokasi" />
