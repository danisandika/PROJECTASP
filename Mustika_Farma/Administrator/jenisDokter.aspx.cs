...
public partial class Administrator_jenisDokter : System.Web.UI.Page
{
    ...
    private DataSet loadData()
    {
        ...
        com.Connection = conn;
        com.CommandText = "sp_SelectJenisDokter";
    ...
    protected void EditbtnSave_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand com = new SqlCommand();
        com.Connection = conn;
        com.CommandText = "[sp_UpdateJenisDokter]";
        com.CommandType = CommandType.StoredProcedure;
    ...
    {
        if (ddlStatusView.SelectedValue == "2")
        {
            loadData();
        }
        else if (ddlStatusView.SelectedValue == "1")
        {
            SqlCommand com = new SqlCommand();
            com.Connection = conn;
            com.CommandText = "[sp_SelectJenisAktifDokter]";
            com.CommandType = CommandType.StoredProcedure;
            com.Parameters.AddWithValue("@namaJenis", txtSearch.Text);
            com.Parameters.AddWithValue("@deskripsi", txtSearch.Text);
        ...
        else if (ddlStatusView.SelectedValue == "0")
        {
            SqlCommand com = new SqlCommand();
            com.Connection = conn;
            com.CommandText = "[sp_SelectJenisNADokter]";
            com.CommandType = CommandType.StoredProcedure;
            com.Parameters.AddWithValue("@namaJenis", txtSearch.Text);
            com.Parameters.AddWithValue("@deskripsi", txtSearch.Text);
            SqlDataAdapter adapt = new SqlDataAdapter(com);
    ...
    protected void lnkViewDetails_Click(object sender, EventArgs e)
    {
        ...
        nama_jenis.Text = row.Cells[1].Text;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand com = new SqlCommand();
        com.Connection = conn;
        com.CommandText = "[sp_InsertJenisDOkter]";
        com.CommandType = CommandType.StoredProcedure;
