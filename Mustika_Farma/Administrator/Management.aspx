<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/MasterPage_Admin.master" AutoEventWireup="true" CodeFile="Management.aspx.cs" Inherits="Administrator_Management" %>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Management Uang</h3>
              </div>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputDesb">Debit</label>
                    <asp:TextBox ID="txtDeskripsi" CssClass="form-control" runat="server" TextMode="MultiLine" />
                  </div>
                  <div class="form-group">
                    <label for="exampleInputkred">Kredit</label>
                    <asp:TextBox ID="txtKredit" CssClass="form-control" runat="server" TextMode="MultiLine" />
                  </div>

                 <div class="form-group">
                    <label for="exampleInputtot">Total</label>
                    <asp:TextBox ID="txtTotal" CssClass="form-control" runat="server" TextMode="MultiLine" />
                  </div>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Table Management Uang</h3>
                  <br />
                ...
                <asp:GridView ID="gridManagement" runat="server" CssClass="table table-hover"
                    AllowPaging="true"
                    AllowSorting="true" AutoGenerateColumns="false" DataKeyNames="idManagement" EmptyDataText="Tidak Ada Data" 
                    PageSize="5" PagerStyle-CssClass="pagination" ShowHeaderWhenEmpty="true" OnPageIndexChanging="gridManagement_PageIndexChanging"
                    OnRowCommand="gridManagement_RowCommand" OnSorting="gridManagement_Sorting" OnSelectedIndexChanged="gridManagement_SelectedIndexChanged" >
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="tanggalTransaksi" HeaderText="Tanggal Transaksi"  NullDisplayText="-" ItemStyle-HorizontalAlign="Left" SortExpression="tanggalTransaksi" />
                        <asp:BoundField DataField="Debit" HeaderText="Debit"  NullDisplayText="-" ItemStyle-HorizontalAlign="Left" SortExpression="Debit" />
                        <asp:BoundField DataField="Kredit" HeaderText="Kredit"  NullDisplayText="-" ItemStyle-HorizontalAlign="Left" SortExpression="Kredit" />
                        <asp:BoundField DataField="Total" HeaderText="Total"  NullDisplayText="-" ItemStyle-HorizontalAlign="Left" SortExpression="Total" />
